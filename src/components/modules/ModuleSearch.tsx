  ...
  return (
    <div className="relative w-full max-w-md">
      ...
      <input
        ...
        className="w-full pl-[40px] pr-md py-sm bg-bg-secondary text-text-main rounded-md border border-bg-secondary focus:outline-none focus:ring-2 focus:ring-accent-primary text-sm shadow-flat-sm"
      />
    </div>
  );
};
